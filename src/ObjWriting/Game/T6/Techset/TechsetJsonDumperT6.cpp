...
void techset::JsonDumperT6::DumpPixelShader(const AssetDumpingContext& context, const MaterialPixelShader* pixelShader)
{
...
void techset::JsonDumperT6::DumpVertexShader(const AssetDumpingContext& context, const MaterialVertexShader* vertexShader)
{
    std::ostringstream ss;
...
void techset::JsonDumperT6::DumpAsset(AssetDumpingContext& context, const XAssetInfo<AssetTechniqueSet::Type>& asset)
{
    const auto* techniqueSet = asset.Asset();
    auto* shaderState = context.GetZoneAssetDumperState<ShaderDumpingZoneState>();
